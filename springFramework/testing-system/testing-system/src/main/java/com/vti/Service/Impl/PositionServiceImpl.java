...
public class PositionServiceImpl implements IPositionService {
    ...
    @Override
    public Page<PositionDTO> findAll(PositionSearchFrom positionSearchFrom, Pageable pageable) {
        ...
        Page<Position> positions = positionRepository.findAll(where, pageable);
        Page<PositionDTO> positionDTOS = positions.map(position -> new PositionDTO(position));
